...
class ListStaff extends Component {
  ...
  renderItem = ({item, index}) => (
    <TouchableOpacity
      style={{backgroundColor: index % 2 == 0 ? 'gray' : 'green',padding:20, marginBottom:8}}
      onPress={() =>
      ...
      <View
        ...
        <Text style={{flex:1, marginRight:10, fontWeight:'bold'}}>Tên NV:</Text>
      ...
      <View
        ...
        <Text style={{flex:1, marginRight:10, fontWeight:'bold'}}>Phòng Ban:</Text>
